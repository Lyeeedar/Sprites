...
{
	float factor1 = 0.1 / 10.0;
	float factor3 = 0.3 / 10.0;
	float factor10 = 0.05 * 10.0;
...
float smoothNoise()
{
	float total = snoise(vec3((v_pos + u_scale_z_offset.zw) / (30.0 * u_scale_z_offset.x), u_scale_z_offset.y));
